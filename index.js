...
const { autoUpdateAndRestart } = require('./utils/autoUpdater'); // ← NEW
...
(async () => {
  // 🔄 Auto-update from GitHub before starting the bot
  await autoUpdateAndRestart(); // Will exit and restart if updates are pulled
